...
version: 7.5.0
downloadLink: 'https://download.newrelic.com/ios_agent/NewRelic_XCFramework_Agent_7.5.0.zip'
---
...
* [Starting the New Relic agent to your watchOS project](/docs/mobile-monitoring/new-relic-mobile-ios/watchOS/watchOS-agent-setup) 
* [WatchOS unsupported features](/docs/mobile-monitoring/new-relic-mobile-ios/watchOS/src/content/docs/mobile-monitoring/new-relic-mobile-ios/watchOS/watchOS-unsupported-features) 
